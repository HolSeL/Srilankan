...
abstract class CBaseListView extends CWidget
{
	...
	{
		$emptyText=$this->emptyText===null ? Yii::t('zii','Результатов нет.') : $this->emptyText;
	...
	public function renderSummary()
	{
		...
		if($this->enablePagination)
		{
			...
			if(($summaryText=$this->summaryText)===null)
				$summaryText=Yii::t('zii','Только 1 страница {start}-{end}.|Результаты с {start} по {end}: всего {count} результата(ов).',$total);
